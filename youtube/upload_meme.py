...
TOKEN_FILES = [
    "./tokens/meme-klakshmanan48.json",
    "./tokens/meme-lakshmanan.coder.json",
    "./tokens/meme-lakshmanan.manvaasam.json",
    "./tokens/meme-lakshmanan.blogger.json",
    "./tokens/meme-codingfrontendweb.json",
]
...
def main():
    video_path = "./sarcasm_output/"
    video_files = [f for f in os.listdir(video_path) if f.endswith(".mp4")]
    os.makedirs("./sarcasm_output/uploaded", exist_ok=True)
        ...
        for thisTokenCount in range(10):
            ...
            try:
                ...
                for channel in channels:
                    ...
                    os.rename(video_file, f"./sarcasm_output/uploaded/{video_files[fileCount]}")
                    fileCount += 1
