...
def schedule_video(service, video_id, timecount, daycount):
    ...
    # Ensure the scheduled time is at least 15 minutes in the future
    # min_future_time = datetime.utcnow() + timedelta(minutes=15)
    # if scheduledTime < min_future_time:
    #     scheduledTime = min_future_time
